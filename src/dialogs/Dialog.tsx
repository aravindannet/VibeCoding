...
const Dialog = ({ open, onClose, title, children }: any) => (
  <div className={`fixed inset-0 z-50 ${open ? "" : "hidden"}`}>
    ...
    <div
      className="absolute left-1/2 top-1/2 w-full max-w-xs sm:max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-2xl border backdrop-blur-2xl shadow-2xl dark:bg-zinc-900/40 dark:border-zinc-700/40 dark:backdrop-blur-md transition-all duration-300"
      style={{
